...
| `stickyCancel`     | boolean                           | Moves the option specified by `cancelButtonIndex` top the bottom of the action sheet and outside of the underlying `ScrollView`. Defaults to `false`.                                                                                                                                                                                                                                                                                                               |
